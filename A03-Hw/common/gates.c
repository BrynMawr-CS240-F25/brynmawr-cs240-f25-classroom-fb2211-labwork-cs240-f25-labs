...
{
  // built-in
  void Nand(uchar a, uchar b, uchar* out) 
  { 
    *out = !(a & b); 
  }
  ...
  void Set16(uchar in[16], uchar out[16])
  {
  }
  ...
  void Dmux4way(uchar in, uchar sel[2], 
  ...
  void Mux4way16(uchar a[16], uchar b[16], 
    uchar c[16], uchar d[16], uchar sel[2], uchar out[16]) 
  { 
  }
